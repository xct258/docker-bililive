...
wget -O /opt/bililive/scripts/弹幕偏移脚本.sh https://raw.githubusercontent.com/xct258/docker-bililive/main/视频处理脚本/弹幕偏移脚本.sh
wget -O /opt/bililive/scripts/xml转ass.sh https://raw.githubusercontent.com/xct258/docker-bililive/main/视频处理脚本/xml转ass.sh
